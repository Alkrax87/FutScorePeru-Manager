...
@Component({
  selector: 'app-stadium-add-modal',
  ...
  template: `
    <div class="bg-black bg-opacity-70 fixed inset-0 z-50 flex justify-center items-center select-none">
      <div class="bg-white p-5 rounded-xl w-full max-w-md">
        <h3 class="text-lg font-semibold">Add New Stadium</h3>
        ...
        <div class="flex flex-col gap-3 pt-4 pb-8">
          ...
          <div class="w-full">
            ...
            <input id="stadiumId" [(ngModel)]="stadium.stadiumId" type="number" min="0"
...
export class StadiumAddModalComponent {
  @Output() add = new EventEmitter<Stadium>();
